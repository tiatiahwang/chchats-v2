      ...
      <div className='flex justify-between items-center px-4'>
        <div className='flex items-center py-4 space-x-2'>
          ...
          <div className='relative'>
            ...
            {imageModal && (
              <div className='absolute top-5 border shadow-md bg-white rounded-md p-4 w-[350px] z-10'>
                {isUploading ? (
                  ...
                  <>
                    ...
                    <div className='justify-end flex'>
                      <span
                        onClick={handleImageModal}
                        className='mt-2 mr-2 bg-main text-white p-2 rounded-md hover:bg-mainDark cursor-pointer'
                      >
                        닫기
                      </span>
                    </div>
